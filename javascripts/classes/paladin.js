...
Spells[17]=new spellPT("Chant of Endurance",2,6073,6,"1 FAT Regen ",6,"",'2000','','','','5s (pulse)','') 
Spells[18]=new spellPT("Chant of Stamina",12,6073,6,"2 FAT Regen ",6,"",'2000','','','','5s (pulse)','') 
Spells[19]=new spellPT("Chant of Persistence",22,6073,6,"3 FAT Regen ",6,"",'2000','','','','5s (pulse)','') 
Spells[20]=new spellPT("Chant of Resilience",32,6073,6,"4 FAT Regen ",6,"",'2000','','','','5s (pulse)','') 
Spells[21]=new spellPT("Chant of Perseverance",42,6073,6,"5 FAT Regen ",6,"",'2000','','','','5s (pulse)','') 
...
Spells[38]=new spellPT("Provoke",5,6065,6,"5.2 ",6,"",'1500','','','20s','','') 
Spells[39]=new spellPT("Aggravate",15,6065,6,"17.1 ",6,"",'1500','','','20s','','') 
Spells[40]=new spellPT("Enrage",30,6065,6,"38.7 ",6,"",'1500','','','20s','','') 
Spells[41]=new spellPT("Infuriate",40,6065,6,"55.6 ",6,"",'1500','','','20s','','') 
...
Lines[6068]=new linePT('Ablative Armor (Group, Chant)','Adds to the target\'s hitpoints temporarily, which are used to absorb damage up to 30% of each individual hit',6,0) 
Spells[59]=new spellPT("Barrier of Faith",30,6068,6,"60 Magical Ablative ",6,"",'1500','','','8s','6s (pulse)','') 
Spells[60]=new spellPT("Barrier of Virtue",40,6068,6,"90 Magical Ablative ",6,"",'1500','','','8s','6s (pulse)','') 
Spells[61]=new spellPT("Barrier of Temperence",50,6068,6,"120 Magical Ablative ",6,"",'1500','','','8s','6s (pulse)','')
Lines[6070]=new linePT('Strength (Self)','Increases the target\'s Strength, which will cause it to be able to carry more weight, do more damage, and be more effective in melee combat',6,0) 
Spells[62]=new spellPT("Righteous Strength",3,6070,6,"17 Str ",6,"3 PP",'','3.0s','','','20m','') 
Spells[63]=new spellPT("Righteous Potency",7,6070,6,"20 Str ",6,"6 PP",'','3.0s','','','20m','') 
Spells[64]=new spellPT("Righteous Power",14,6070,6,"26 Str ",6,"11 PP",'','3.0s','','','20m','') 
