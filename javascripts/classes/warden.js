...
Spells[idx++]=new spellPT("Cure Poison",7,45083,45,"",45,"6% ",'1500','3.2s','','','','') 
Lines[45084]=new linePT('Cure Disease','Attempts to cure target of all disease.',45,0) 
Spells[idx++]=new spellPT("Cure Disease",9,45084,45,"",45,"6% ",'1500','3.2s','','','','')
...
Lines[45068]=new linePT('Proc Buff (Self, Group Heal)','Spell that adds a small chance for your weapon to proc a group heal.',45,0) 
...
Lines[49093]=new linePT('Proc Buff (Self, PBAOE Heal)','Spell that adds a small chance for your weapon to proc a PBAOE heal.',45,0) 
