...
Abilities[18]=new abilityPT("Shields",5,97,5,1,0,0)
...
Lines[45083]=new linePT('Cure Poison','Attempts to cure target of all poisons.',45,0) 
Spells[idx++]=new spellPT("Cure Poison",7,45083,45,"",45,"6% ",'2000','3.2s','','','','') 
Lines[45084]=new linePT('Cure Disease','Attempts to cure target of all disease.',45,0) 
Spells[idx++]=new spellPT("Cure Disease",9,45084,45,"",45,"6% ",'2000','3.2s','','','','')
...
Lines[45068]=new linePT('Offensive Proc Buff (Self, Group Heal)','Spell that adds a small chance for your weapon to proc a group heal.',45,0) 
Spells[idx++]=new spellPT("Lesser Nature's Gift",8,45068,45,'15 HP',45,'8 PP','2000','3s','','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Lesser Nature's Favor",16,45068,45,'30 HP',45,'10 PP','2000','3s','','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Lesser Nature's Token",24,45068,45,'45 HP',45,'13 PP','2000','3s','','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Nature's Gift",32,45068,45,'60 HP',45,'17 PP','2000','3s','','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Nature's Favor",40,45068,45,'75 HP',45,'21 PP','2000','3s','','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Nature's Token",48,45068,45,'100 HP',45,'25 PP','2000','3s','','30s','20min','25% Proc Chance')
...
Lines[49093]=new linePT('Offensive Proc Buff (Self, PBAOE Heal)','Spell that adds a small chance for your weapon to proc a PBAOE heal.',45,0) 
Spells[idx++]=new spellPT("Nature's Curator",10,49093,49,'25 HP',49,'5 PP','','3s','350','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Nature's Deacon",20,49093,49,'50 HP',49,'12 PP','','3s','350','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Nature's Keeper",30,49093,49,'75 HP',49,'17 PP','','3s','350','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Nature's Steward",40,49093,49,'100 HP',49,'21 PP','','3s','350','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Nature's Sentinal",50,49093,49,'125 HP',49,'25 PP','','3s','350','30s','20min','25% Proc Chance')