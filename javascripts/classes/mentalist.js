...
Lines[35020]=new linePT('Damage over Time','Inflicts damage to the target every 2.0 seconds repeatedly over a given time period.',35,0) 
Spells[59]=new spellPT("Minor Mind Fade",1,35020,35,"2  D x 6 ",35,"2 PP",'1500','3.0s','','','12s','Energy') 
Spells[60]=new spellPT("Lesser Mind Fade",5,35020,35,"9  D x 6 ",35,"4 PP",'1500','3.0s','','','12s','Energy') 
Spells[61]=new spellPT("Mind Fade",8,35020,35,"15  D x 6 ",35,"5 PP",'1500','3.0s','','','12s','Energy') 
Spells[62]=new spellPT("Lesser Mind Dissolution",11,35020,35,"19  D x 6 ",35,"7 PP",'1500','3.0s','','','12s','Energy') 
Spells[63]=new spellPT("Mind Dissolution",15,35020,35,"27  D x 6 ",35,"9 PP",'1500','3.0s','','','12s','Energy') 
Spells[64]=new spellPT("Greater Mind Dissolution",20,35020,35,"35  D x 6 ",35,"12 PP",'1500','3.0s','','','12s','Energy') 
Spells[65]=new spellPT("Lesser Mind Melt",25,35020,35,"45  D x 6 ",35,"15 PP",'1500','3.0s','','','12s','Energy') 
Spells[66]=new spellPT("Mind Melt",30,35020,35,"53  D x 6 ",35,"19 PP",'1500','3.0s','','','12s','Energy') 
Spells[67]=new spellPT("Greater Mind Melt",35,35020,35,"63  D x 6 ",35,"22 PP",'1500','3.0s','','','12s','Energy') 
Spells[68]=new spellPT("Mind Annihilation",41,35020,35,"73  D x 6 ",35,"26 PP",'1500','3.0s','','','12s','Energy') 
Spells[69]=new spellPT("Complete Mind Annihilation",48,35020,35,"87  D x 6 ",35,"31 PP",'1500','3.0s','','','12s','Energy') 
Lines[35024]=new linePT('Damage over Time (AOE)','Inflicts damage to the target every 2 seconds repeatedly over a given time period. This is an \"Area of Effect\" (AOE) spell which can affect multiple targets in the spell\'s radius.',35,0) 
Spells[70]=new spellPT("Shroud of Madness",17,35024,35,"31  D x 6 ",35,"16 PP",'1500','3.0s','350','','12s','Energy') 
Spells[71]=new spellPT("Fog of Delirium",23,35024,35,"41  D x 6 ",35,"22 PP",'1500','3.0s','350','','12s','Energy') 
Spells[72]=new spellPT("Hallucinatory Winds",29,35024,35,"53  D x 6 ",35,"28 PP",'1500','3.0s','350','','12s','Energy') 
Spells[73]=new spellPT("Torrent of Dementia",36,35024,35,"65  D x 6 ",35,"36 PP",'1500','3.0s','350','','12s','Energy') 
Spells[74]=new spellPT("Storm of Insanity",46,35024,35,"83  D x 6 ",35,"47 PP",'1500','3.0s','350','','12s','Energy') 
...
Lines[40020]=new linePT('Damage over Time','Inflicts damage to the target ever 2.5 seconds repeatedly over a given time period.',40,0) 
Spells[84]=new spellPT("Illusory Ache",1,40020,40,"2  D x 4 ",40,"1 PP",'1500','3.0s','','','10s','Energy') 
Spells[85]=new spellPT("Illusory Pains",5,40020,40,"9  D x 4 ",40,"3 PP",'1500','3.0s','','','10s','Energy') 
Spells[86]=new spellPT("Illusory Cramps",8,40020,40,"15  D x 4 ",40,"4 PP",'1500','3.0s','','','10s','Energy') 
Spells[87]=new spellPT("Illusory Anguish",11,40020,40,"19  D x 4 ",40,"5 PP",'1500','3.0s','','','10s','Energy') 
Spells[88]=new spellPT("Illusory Spasms",15,40020,40,"27  D x 4 ",40,"7 PP",'1500','3.0s','','','10s','Energy') 
Spells[89]=new spellPT("Illusory Convulsions",20,40020,40,"35  D x 4 ",40,"9 PP",'1500','3.0s','','','10s','Energy') 
Spells[90]=new spellPT("Illusory Agony",25,40020,40,"45  D x 4 ",40,"12 PP",'1500','3.0s','','','10s','Energy') 
Spells[91]=new spellPT("Illusory Lacerations",30,40020,40,"53  D x 4 ",40,"15 PP",'1500','3.0s','','','10s','Energy') 
Spells[92]=new spellPT("Illusory Torture",35,40020,40,"63  D x 4 ",40,"17 PP",'1500','3.0s','','','10s','Energy') 
Spells[93]=new spellPT("Illusory Excrutiation",41,40020,40,"73  D x 4 ",40,"20 PP",'1500','3.0s','','','10s','Energy') 
Spells[94]=new spellPT("Illusory Neuralgia",48,40020,40,"87  D x 4 ",40,"24 PP",'1500','3.0s','','','10s','Energy') 
