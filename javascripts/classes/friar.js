...
Lines[78101]=new linePT('Heal over Time (Group)','Target is healed every 3 sec during the spell\'s duration.',78,0) 
Spells[idx++]=new spellPT("Blessed Encouragement",24,78101,78,"43 HP ",78,"61 PP",'2000','4.0s','','','30s','') 
Spells[idx++]=new spellPT("Holy Encouragment",34,78101,78,"58 HP ",78,"79 PP",'2000','4.0s','','','30s','') 
Spells[idx++]=new spellPT("Champion's Encouragment",44,78101,78,"73 HP ",78,"94 PP",'2000','4.0s','','','30s','') 
...
Lines[78102]=new linePT('Proc Buff (Self, Group Heal)','Spell that adds a small chance for your weapon to proc a group heal',78,0) 
Spells[idx++]=new spellPT("Prophet\'s Penitence",8,78102,78,'15 HP ',78,'8 PP','2000','3.0s','','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Prophet\'s Faith",16,78102,78,'30 HP ',78,'10 PP','2000','3.0s','','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Prophet\'s Piety",24,78102,78,'45 HP ',78,'13 PP','2000','3.0s','','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Prophet\'s Conviction",32,78102,78,'60 HP ',78,'17 PP','2000','3.0s','','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Prophet\'s Fidelity",40,78102,78,'75 HP ',78,'21 PP','2000','3.0s','','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Prophet\'s Dogma",48,78102,78,'100 HP ',78,'25 PP','2000','3.0s','','30s','20min','25% Proc Chance')
...
Lines[80074]=new linePT('Fatigue Reduction (Group)','Reduces the fatigue cost of combat styles used by the caster.',80,0) 
Spells[idx++]=new spellPT("Saint's Energy",12,80074,80,"10% ",80,"10% ",'1500','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Saint's Stamina",22,80074,80,"15% ",80,"10% ",'1500','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Saint's Persistence",32,80074,80,"20% ",80,"10% ",'1500','3.0s','','','20m','') 
Spells[idx++]=new spellPT("Saint's Tenacity",42,80074,80,"25% ",80,"10% ",'1500','3.0s','','','20m','') 
...
Lines[80007]=new linePT('Offensive Proc Buff (Self, PBAOE Heal)','Spell that adds a small chance for your weapon to proc a PBAOE heal.',80,0) 
Spells[idx++]=new spellPT("Acolyte's Redemption",10,80007,80,'25 HP',80,'5 PP','','3s','350','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Chaplain's Redemption",20,80007,80,'50 HP',80,'12 PP','','3s','350','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Fanatic's Redemption",30,80007,80,'75 HP',80,'17 PP','','3s','350','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Inquisitor's Redemption",40,80007,80,'100 HP',80,'21 PP','','3s','350','30s','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Zealot's Redemption",50,80007,80,'125 HP',80,'25 PP','','3s','350','30s','20min','25% Proc Chance')
Lines[80009]=new linePT('Defensive Proc Buff (Group, Heal)','Target regenerates healing via melee attacks against them',80,0) 
Spells[idx++]=new spellPT("Protection from Fear",9,80009,80,'15 HP',80,'9 PP','1500','3s','','','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Protection from Doubt",17,80009,80,'30 HP',80,'11 PP','1500','3s','','','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Protection from Dissent",25,80009,80,'45 HP',80,'15 PP','1500','3s','','','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Protection from Anarchy",33,80009,80,'60 HP',80,'19 PP','1500','3s','','','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Protection from Idleness",41,80009,80,'75 HP',80,'24 PP','1500','3s','','','20min','25% Proc Chance')
Spells[idx++]=new spellPT("Protection from Heresy",49,80009,80,'100 HP',80,'32 PP','1500','3s','','','20min','25% Proc Chance')