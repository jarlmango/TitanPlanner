	...
	document.write("<td class='unique' align='center' width='125'>Pre-req Skill</td>");
	document.write("<td class='unique' align='center'>Pre-req Level</td>");
	...
	while (x<=moo)	{
		...
		document.write("<tr>");
		document.write("<td width='80' align='center'><input readonly='readonly' name='frm"+raID+"' class='frmtext2' size='2' value='"+arrData[raID].level+"'>");
		...
		if (arrData[raID].indent)	{document.write("<td height='35'>&nbsp;&nbsp;&nbsp;&nbsp;"+arrData[raID].name+"</td>");}
		else {document.write("<td height='35' width='150' class='grey'><b>"+arrData[raID].name+"</b></td>");}
		document.write("<td align='center'>"+arrData[raID].type+"</td>");
		count=1;
		while (count<=5) {
			if (arrData[raID].cost[count]==0)	{document.write("<td align='center' width='20'>-</td>");}
			else {
				check=override(classID,raID);
				if (check==0)	{document.write("<td align='center' width='20'>"+arrData[raID].cost[count]+"</td>");}
		...
		if (temp==0)	{
			...
			document.write("<td align='center'><i>Augmented Con.</i></td>");
			document.write("<td align='center'>"+arrData[raID].reqlvl+"</td>");}
			
			else {
			
			document.write("<td align='center'><i>"+arrData[temp].name+"</i></td>");
			document.write("<td align='center'>"+arrData[raID].reqlvl+"</td>");}
			}
		
		extraDesc = arrData[raID].evalue ? "<span>"+arrData[raID].evalue+" / lvl</span>":"";
		document.write("<td>"+arrData[raID].description+"</td>");
		document.write("</tr>");
		x=x+1;
		}
